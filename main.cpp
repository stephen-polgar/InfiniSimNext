...
// Pinetime::Controllers::FS filesystem{spiNorFlash};  // not work ??
...
Pinetime::Applications::DisplayApp displayApp(lcd,
                                              touchPanel,
                                              spiNorFlash);  //  filesystem);  not working
...
public:
  ...
  void switch_to_screen(uint8_t screen_idx)
  {
    ...
    {
      displayApp.StartApp(Pinetime::Applications::Apps::BatteryInfo, Pinetime::Applications::Screens::Screen::FullRefreshDirections::None);
    }
    else if (screen_idx == 9)
    {
      displayApp.StartApp(Pinetime::Applications::Apps::FlashLight, Pinetime::Applications::Screens::Screen::FullRefreshDirections::None);
    }
    else if (screen_idx == 0)
    {
      displayApp.StartApp(Pinetime::Applications::Apps::QuickSettings, Pinetime::Applications::Screens::Screen::FullRefreshDirections::None);
    }
    else if (screen_idx == 11)
    {
      displayApp.StartApp(Pinetime::Applications::Apps::Music, Pinetime::Applications::Screens::Screen::FullRefreshDirections::None);
    }
    else if (screen_idx == 13)
    {
      displayApp.StartApp(Pinetime::Applications::Apps::SysInfo, Pinetime::Applications::Screens::Screen::FullRefreshDirections::None);
    }
    else if (screen_idx == 14)
    {
      displayApp.StartApp(Pinetime::Applications::Apps::Steps, Pinetime::Applications::Screens::Screen::FullRefreshDirections::None);
    }
    else if (screen_idx == 15)
    {
      displayApp.StartApp(Pinetime::Applications::Apps::Error, Pinetime::Applications::Screens::Screen::FullRefreshDirections::None);
    }
    else if (screen_idx == 17)
    {
      displayApp.StartApp(Pinetime::Applications::Apps::PassKey, Pinetime::Applications::Screens::Screen::FullRefreshDirections::None);
    }
    else
    {
